...
Транзакцию начинают командой BEGIN, за которой следуют отдельные команды, в промежутках между которыми БД может существовать в несогласованном состоянии.
