...
Триггер вызывает функцию тогда когда происходит определенное событие, относящееся к таблице или представлению (view), такое как INSERT, UPDATE, DELETE. Когда заданное событие происходит, то триггер вызывает функцию или процедуру, которая выполняет нужне действия. Можно установить триггер на срабатывание Перед, После или Вместо события, а также можно установить триггер на срабатывание для каждой строки затрагиваемой событием, либо один раз для целой операции. Например при удалении 20 строк из таблицы можно установить триггер для срабатывания один раз или при удалении каждой строки.
