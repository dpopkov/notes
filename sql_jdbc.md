...
Подзапрос - это вложенная команда SELECT, заключенная в круглые скобки и являющийся частью более общего запроса. Подзапрос получает значения или набор данных, который используется в основном запросе.
